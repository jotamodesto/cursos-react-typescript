...
import TabsHeader from '../common/template/tab/tabsHeader'
import TabsContent from '../common/template/tab/tabsContent'
import TabHeader from '../common/template/tab/tabHeader'
import TabContent from '../common/template/tab/tabContent'
import { selectTab, showTabs } from "../common/template/tab/tabActions";
import { create, update, remove, initForm } from './billingCycleActions'
...
const mapDispatchToProps = dispatch => bindActionCreators({selectTab, showTabs, create, update, remove, initForm}, dispatch)
